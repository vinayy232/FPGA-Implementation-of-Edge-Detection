...
################################################################
# This is a generated script based on design: imageProcessingSystem
#
...
# source imageProcessingSystem_script.tcl
...
set design_name imageProcessingSystem
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net EdgeDetection_0_m_axis [get_bd_intf_pins EdgeDetection_0/m_axis] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets EdgeDetection_0_m_axis] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets EdgeDetection_0_m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins EdgeDetection_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins EdgeDetection_0/axi_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
